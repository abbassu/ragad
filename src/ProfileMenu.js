...
const ProfileMenu = () => {
  ...
  const [profilePhoto, setProfilePhoto] = useState(
    "https://i.pinimg.com/564x/48/3f/31/483f31f66af1cdfa36768d5633b2d834.jpg"
  );
  ...
  return (
    <div className="container">
        ...
        <div class="col-lg-3">
          <div className="profile-menu d-block px-2 px-lg-0">
            ...
            <div className="profile-details pt-0">
              ...
              >
                <a href="p">
                  <img className="profile-img border-3" src="" alt=""></img>
                </a>
              </div>
            ...
            <div className="buttons">
              <div button className="button" href="">
              ...
              <div button className="button">
                <IoIosNotifications color="yellow" border="black" siza="15px" />{" "}
                Notifications
              </div>
              <div button className="button">
      ...
      {/* <ul className="more">
        <li className="acssess">
          <a className="accessButton" href=" ">
            About
          </a>{" "}
        </li>
        <li className="acssess">
